...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 ...
                 distill=None, script_teacher=None, config_teacher=None, tensorboard_dir=None, stage1_model=None):
    ...
    settings.env.tensorboard_dir = tensorboard_dir
...
def main():
    ...
    parser.add_argument('--config', type=str, default='vitb_256_fuse_embed_32x4_4e4_lasher_15ep_in1k_online', help="Name of the config file.")
    parser.add_argument('--stage1_model', type=str, default='CheckPoint_stage1/checkpoints/train/tbsi_track/vitb_256_fuse_embed_32x4_4e4_lasher_15ep_in1k/TBSITrack_ep0015.pth.tar', help='stage1 model path')
    parser.add_argument('--save_dir', type=str,  default='CheckPoint_stage2', help='the directory to save checkpoints and logs')
    # parser.add_argument('--config', type=str, default='vitb_256_fuse_embed_32x4_4e4_lasher_15ep_in1k', help="Name of the config file.")
    # parser.add_argument('--stage1_model', type=str, default='', help='stage1 model path')
    # parser.add_argument('--save_dir', type=str,  default='CheckPoint_stage1', help='the directory to save checkpoints and logs')
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 distill=args.distill, script_teacher=args.script_teacher, config_teacher=args.config_teacher, tensorboard_dir=args.tensorboard_dir, stage1_model=args.stage1_model)
