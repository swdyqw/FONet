...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'lasher_train_dir': '/media/disk1/RGBT_Datasets/LASHER_TRAIN/',
        'lasher_test_dir': '/media/disk1/RGBT_Datasets/LASHER_TEST/',
        'rgbt234_dir': '/media/disk1/RGBT_Datasets/RGBT234/',
        'imagenetdet_dir': empty_str,
        'ecssd_dir': empty_str,
        'hkuis_dir': empty_str,
        'msra10k_dir': empty_str,
