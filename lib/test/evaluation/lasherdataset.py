...
class LasHeRDataset(BaseDataset):
    ...
    def __init__(self, split):
        ...
        if split == 'testingset' or split == 'val':
            ...
            self.base_path = os.path.join(self.env_settings.lasher_path)
        else:
    ...
    def _construct_sequence(self, sequence_name):
        ...
        return Sequence(sequence_name, frames_list_v,frames_list_i, 'lasher', ground_truth_rect.reshape(-1, 4))
